    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_path', models.CharField(help_text='Путь к странице', max_length=50, verbose_name='url')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pathPictiries', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imgPages', to='apps.picturiesmodel')),
            ],
        ),
        migrations.CreateModel(
            name='MiddlePages',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('education', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='educationMainPage', to='apps.workexperiencemodel', unique='Null')),
                ('experience', models.ForeignKey(help_text='Превью описания опыта и краткое описание \n3\n\t\t          из базовой страницы. Свойство - НЕ ОБЯЗАТЕЛЬНО', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experienceMainPage', to='apps.workexperiencemodel', unique='Null')),
                ('pages', models.ForeignKey(help_text='Заголовок и краткое описание из базовой страницы', on_delete=django.db.models.deletion.CASCADE, related_name='previewForMainPage', to='apps.pagesmodel')),
            ],
            options={
